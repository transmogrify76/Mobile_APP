                    ...
                    return (
                      <div
                        ...
                        className={`bg-gray-50 rounded-xl p-4 border ${
                          isThisCharger ? 'border-teal-300' : 'border-gray-200'
                        }`}
                      >
              ...
              {transactions.length === 0 ? (
                <>
                  <div className="mb-4">
                    ...
                    <select
                      className="w-full bg-white text-black border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-teal-500"
                  ...
                  <button
                    ...
                    className="w-full bg-teal-600 hover:bg-teal-700 text-white font-medium py-3 rounded-xl flex items-center justify-center gap-2 transition disabled:opacity-50"
                  >
                    {startLoading ? (
